...
const filters = [
  
  {
    ...
    options: [
      ...
      { value: 'Electronics', label: 'Organization', checked: false },
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-10">
            <h1 className="lg:text-4xl text-xl md:text-4xl font-bold tracking-tight text-gray-900">New Arrivals</h1>
                  ...
                  <Disclosure as="div" key={section.id} className="border-b border-gray-200 py-6">
                    {({ open }) => (
                      <>
                        ...
                        <Disclosure.Panel className=" bg-white px-6 py-8 rounded ">
